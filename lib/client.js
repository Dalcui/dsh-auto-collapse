...
`;
  var FoldController = class {
    constructor() {
      ...
      this.scrollBodies = /* @__PURE__ */ new Map();
    ...
    stop() {
      ...
      for (const [host, body] of [...this.scrollBodies]) {
        for (const row of [...body.children]) {
          ...
          if (o !== void 0 && o.parent !== null) o.parent.insertBefore(row, o.next);
        }
        body.remove();
    ...
    pass() {
      ...
      for (const block of blocks) {
        ...
        if (isExpanded) {
          ...
          if (body !== void 0 && body.style.display !== "none") body.style.display = "none";
        }
    ...
    ensureScrollBody(host, chip) {
      const existing = this.scrollBodies.get(host);
      if (existing !== void 0 && existing.isConnected) return existing;
    ...
    ensureRowsInBody(body, host, rows) {
      for (const row of rows) {
