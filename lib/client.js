...
var __dshcfBundle = (() => {
  ...
  function computeTurnMetrics(turn, order, nodes, turnTimings, nodeKey) {
    ...
    const segIndex = order !== void 0 && nodes !== void 0 ? getTurnSegIndex(order, nodes) : void 0;
    const targetSeg = nodeKey === void 0 || segIndex === void 0 ? 0 : segIndex.segOf.get(nodeKey) ?? 0;
    let input = 0;
    let output = 0;
    let cacheRead = 0;
    let cacheWrite = 0;
    ...
    let turnTailUsage;
    let turnTailSeg;
    const bucket = segIndex === void 0 ? void 0 : segIndex.keysByTurn.get(turn);
      ...
      if (n.kind === "tool-call") {
        ...
        if (n.data && n.data.usage !== null && typeof n.data.usage === "object") {
          ...
          if (settled && stepTiming !== null && typeof stepTiming === "object") {
            ...
            if (typeof firstToken === "number" && isFinite(firstToken) && typeof completed === "number" && isFinite(completed) && typeof stepOut === "number" && isFinite(stepOut) && stepOut >= 0 && completed > firstToken) {
    ...
    if (tokensPerSecond === void 0 && liveDecodeMs > 0) {
  ...
  var FoldController = class {
    ...
    pass() {
      ...
      for (const segment of segments) {
        ...
        const keys = segmentMetricsKeys(segment);
        if (keys.turn !== void 0 && nativeOpenTurns.has(String(keys.turn))) nativeOpenSegments.add(segment.key);
      }
      for (const segment of segments) {
