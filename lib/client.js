...
var __dshcfBundle = (() => {
  ...
  var segOrdinalCache = /* @__PURE__ */ new Map();
  var SEG_ORDINAL_CACHE_MAX = 512;
  function cachedSegOrdinal(nodeKey, order, nodes) {
    if (nodeKey === void 0) return 0;
    if (nodes === void 0 || typeof nodes.values !== "function") {
      return computeSegOrdinal(nodeKey, order, nodes);
    }
    const valuesEpoch = nodes.values();
    const hit = segOrdinalCache.get(nodeKey);
    if (hit !== void 0 && hit.order === order && hit.valuesEpoch === valuesEpoch) return hit.value;
    ...
    if (segOrdinalCache.size > SEG_ORDINAL_CACHE_MAX) {
      segOrdinalCache.delete(segOrdinalCache.keys().next().value);
    }
    return value;
  }
...
`;
  var FoldController = class {
    ...
    pass() {
      ...
      if (nativeTurns === void 0) {
        nativeTurns = /* @__PURE__ */ new Set();
  ...
  var nativeTurnTurnsCache = /* @__PURE__ */ new WeakMap();
