  ...
  function buildGroupsFromIndex(turn, segIndex, nodes, turnTimings) {
    ...
    if (groupCount <= 1) {
      ...
      for (const seg of segs) {
        ...
        if (g.firstTokenTime !== void 0 && (turnAcc.firstTokenTime === void 0 || g.firstTokenTime < turnAcc.firstTokenTime)) {
          turnAcc.firstTokenTime = g.firstTokenTime;
        }
        if (g.firstStepStart !== void 0 && (turnAcc.firstStepStart === void 0 || g.firstStepStart < turnAcc.firstStepStart)) {
...
`;
  var FoldController = class {
    ...
    pass() {
      ...
      const multiGroupTurn = /* @__PURE__ */ new Set();
      const injectorTurns = /* @__PURE__ */ new Set();
      for (const segment of segments) {
      ...
      for (const segment of segments) {
        ...
        const multi = injectorTurns.has(id) ? multiGroupTurn.has(id) : (contentSegsOfTurn.get(id) ?? 1) > 1;
  ...
  function segmentMetricsKeys(segment) {
    ...
    for (const el of candidates) {
      ...
      if (publishedSeg === void 0) {
        publishedSeg = parseSeg(el.getAttribute("data-dshcf-seg"));
      }
      if (turn !== void 0 && sessionId !== void 0 && segOrdinal !== void 0 && publishedSeg !== void 0) break;
    }
