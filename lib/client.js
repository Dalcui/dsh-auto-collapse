...
`;
  var FoldController = class {
    constructor(statusTextProvider2, summaryFieldsProvider2, codeDescriptionProvider2) {
      this.observer = null;
      this.raf = 0;
      this.timer = 0;
      this.disposed = false;
  ...
  function updateChip(chip, rows, expanded, statusRows = [], working = false, codeDescriptionMode = "always") {
