...
// ---------------------------------------------------------------------------
{
  ...
  const context2 = seat(flow, 'context', 'c2', 30)
  const contextRow2 = el('div', { 'data-disclosure-row': '' }, context2)
  el('span', { class: 'title', text: '上下文注入' }, contextRow2)
  el('span', { class: 'summary', text: 'README' }, contextRow2)
  ...
  makeThinkRow({ summary: '再想一点', parent: thinkBody })
...
// ---------------------------------------------------------------------------
{
  ...
  makeThinkRow({ summary: '再想一下', parent: bd })
